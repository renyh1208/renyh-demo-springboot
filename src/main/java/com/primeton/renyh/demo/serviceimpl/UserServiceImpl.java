...
public class UserServiceImpl implements IUserService {
	...
	public ResponseResult<User> getUser(Integer id) {
		//校验是否成功返回数据
		return checkIsSuccessFu(userDao.getUser(id));
	}
	...
	public ResponseResult<User> modifyUser(User user) throws DemoException {
		...
		// 修改数据进行返回数据
		return checkIsSuccessFu(userDao.getUser(user.getUid()));
	}
